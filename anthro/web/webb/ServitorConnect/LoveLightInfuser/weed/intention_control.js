document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (e) {
        ...
        statusText.textContent = "Infusing Weed to You";

        // Send the intention to the server
        const hawkinsValue = hawkinsLevel.value;
        const intention = "A private, personal, energy bubble of ${hawkinsValue} Hawkins Level holds the intention 'I am filled with Love/Light of Creator and experience the perfect balance of relaxation, enjoyment, and clarity from this cannabis to the optimal level for me.' and automatically reposts to the servitor at an optimal time interval.";
