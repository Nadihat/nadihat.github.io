document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (e) {
        ...
        statusText.textContent = "Infusing Wealth and Abundance to You";

        // Send the intention to the server
        const hawkinsValue = hawkinsLevel.value;
        const intention = "A private, personal, energy bubble of ${hawkinsValue} Hawkins Level holds the intention 'I am filled with the Love/Light of the Creator and attract unlimited wealth, abundance, and financial independence effortlessly. I experience perfect balance in managing, growing, and enjoying my financial resources with clarity, confidence, and ease.' This intention automatically reposts to the servitor at an optimal time interval.";
